...
class TftpServerState(TftpState):
    ...
    def serverInitial(self, pkt, raddress, rport):
        ...
        # AGreen BHM - 9-6-2013 - ASCII appears to work, disabling non-Octet check.
        #if pkt.mode != 'octet':
        #    self.sendError(TftpErrors.IllegalTftpOp)
        #    raise TftpException, \
...
class TftpStateServerRecvWRQ(TftpServerState):
    ...
    def handle(self, pkt, raddress, rport):
        ...
        #AGreen BHM - 9-6-2013 - Disabling warning of file existing, as files are expected to exist
		#if os.path.exists(path):
